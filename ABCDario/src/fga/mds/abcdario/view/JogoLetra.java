...
public class JogoLetra extends AbstractActivity {
	...
	public void definirEventos() {
		...
		bt_voltar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				resultado[0] = cont_acerto;
				resultado[1] = cont_erro;
				
				Bundle params = new Bundle();
				params.putIntArray("OK", resultado);
				//Intent it = new Intent(JogoNumero.this, Score.class);
				//it.putExtras(params);
				//startActivity(it);
			}
		});
